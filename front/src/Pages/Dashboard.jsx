            ...
            <main className="pt-32 pb-20">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex flex-col md:flex-row justify-between items-center mb-12 gap-6">
                        <div>
                            <h1 className="text-4xl font-black text-slate-900 mb-2">Welcome back, {user.name}!</h1>
                    ...
                    <div className="grid md:grid-cols-4 gap-6 mb-12 text-center">
                        {[
                            { label: 'Exams Taken', val: stats.exams_taken, color: 'text-primary' },
                            { label: 'Avg Score', val: stats.avg_score, color: 'text-accent' },
                            { label: 'Questions Solved', val: stats.questions_solved, color: 'text-slate-900' },
                            { label: 'Study Hours', val: stats.study_hours, color: 'text-primary-light' },
                        ].map((stat, i) => (
                                    ...
                                    {[1, 2, 3].map((_, i) => (
                                        <div key={i} className="py-6 flex items-center justify-between first:pt-0 last:pb-0">
                                            ...
                                            <div className="flex items-center gap-6">
                                                ...
                                                <Link to="#" className="p-3 bg-slate-50 rounded-xl hover:bg-primary/10 hover:text-primary transition-all">
