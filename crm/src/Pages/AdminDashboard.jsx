...
export default function AdminDashboard() {
    ...
    if (loading) return <div className="text-white flex items-center justify-center h-96 font-sans tracking-tight">Accessing Database...</div>;
            ...
            <div className="grid lg:grid-cols-2 gap-8">
                ...
                <div className="bg-slate-900 rounded-3xl border border-slate-800 p-8 shadow-2xl">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <Link to="/products" className="p-6 bg-slate-800 rounded-2xl border border-slate-700 text-center hover:bg-orange-500/20 hover:border-orange-500/50 transition-all group block">
                            <div className="text-2xl mb-2 group-hover:scale-110 transition-transform">📚</div>
